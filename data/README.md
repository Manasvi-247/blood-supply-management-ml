...
All 27 visualizations generated by the notebooks are stored in the `visualizations/` folder:

| Category | Files |
|----------|-------|
| Demand Analysis | demand_*.png, time_series_*.png |
| Forecasting | sarima_forecast.png, ml_forecast.png, all_models_comparison.png |
| Donor Analysis | donor_*.png, uci_*.png |
| Segmentation | cluster_*.png, 3d_clusters.png, final_segmentation.png |
| Recommender | recommender_results.png, outreach_simulation.png |
| Inventory | utilization_wastage.png, inventory_performance.png |
